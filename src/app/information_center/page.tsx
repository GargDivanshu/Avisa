...
export default function Page() {
      ...
      return (
        ...
        <main className="text-black bg-white relative flex min-h-screen h-[2900px] md:h-[1800px] flex-col items-center md:px-24 px-6">
            <Navbar/>
            <div className="bg-gradient-to-tr from-slate-500 to-stone-700">
            <div className="w-screen filter mix-blend-overlay bg-cover relative bg-[url('/AllBanner.png')] object-cover h-[100px] md:h-[200px]">
            </div>
      </div>
      <div className="text-4xl text-primary font-bold absolute rounded-md w-4/5 text-left right-0 left-0 top-24 md:top-44 mx-auto bg-white h-fit p-8 mb-8">
      Press Coverage 
